...
def main():
    ...
    allowed={'palace.exe','palace-sparams.exe','msmpi.dll','libifcoremd.dll','libmmd.dll','svml_dispmd.dll','msvcp140.dll','vcruntime140.dll','vcruntime140_1.dll'}
    ...
    (ROOT/'.work/package/stage-verification.json').write_text(json.dumps(result,indent=2)+'\n')
