...
def add_notices(stage):
    ...
    for name in ['README.txt','Run-Palace.cmd','RUNTIME_TERMS.txt','REDISTRIBUTION_REVIEW.md','REDISTRIBUTION_MATRIX.json','REDISTRIBUTION_MATRIX.md','METIS_REPLACEMENT.txt','CLEAN_HOST_TEST.md','Test-CleanHost.ps1','Test-Paths.ps1','Test-Payload.ps1','Test-OutputFiles.ps1','Test-Launcher.ps1']:
